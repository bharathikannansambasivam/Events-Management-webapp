...
const MonthGridWrapper = ({ $app, id }) => {
    ...
    return (jsx(AppContext.Provider, { value: $app, children: jsx("div", { id: id, className: "sx__month-grid-wrapper month-grid", children: month.map((week, index) => (jsx(MonthGridWeek, { week: week, isFirstWeek: index === 0, isLastWeek: index === month.length - 1 }, index))) }) }));
};
